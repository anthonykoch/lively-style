...
/**
 * Retrieves runtime variable and property values from a Scss stylesheet.
 *
 * The filename must be absolute and will be used to resolve other stylesheets with
 * relative names. However, it does not need to be a filename existing on disk.
 *
